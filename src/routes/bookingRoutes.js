...
const { createBookingService, viewBookingService, deleteBookingService, viewAllBookingService, cancelBooking } = require('../controllers/bookingController');
...
router.get('/:id', roleCheckMiddleware(['customer', 'organizer', 'admin']), verifyTokenMiddleware, checkProfileOwnershipMiddleware, viewBookingService); // view the booking.
